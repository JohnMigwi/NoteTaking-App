...
public class NoteActivity extends AppCompatActivity {
    ...
    //activity to save when user changes or leaves the note
    @Override
    ...
    private void sendEmail() {
        //using an implicit intent to do just that
        CourseInfo course=(CourseInfo) mSpinnerCourses.getSelectedItem();
        String subject=mTextNoteTitle.getText().toString();
        String text="github at /johnmigwi \""+course.getTitle()+"\"n"+mTextNoteText.getText();
        Intent intent=new Intent(Intent.ACTION_SEND);
        intent.setType("message/rfc2822");//mime type of email messages
